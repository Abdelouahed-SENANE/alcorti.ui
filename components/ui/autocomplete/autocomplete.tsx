...
const inputVariants = cva(
  "outline-none flex w-full text-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 [[readonly]]:bg-muted/80 [[readonly]]:cursor-not-allowed border border-border focus-visible:border-ring aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50  bg-card rounded-md text-sm transition-colors focus-visible:ring-primary/50 focus-visible:ring-3 aria-invalid:ring-3",
  {
    variants: {
      size: {
...
function AutocompleteTrigger({
  ...
  return (
    <AutocompletePrimitive.Trigger
      ...
      {...props}
    >
      <ChevronDown className="size-4 opacity-70 mr-2" />
    </AutocompletePrimitive.Trigger>
  );
}
